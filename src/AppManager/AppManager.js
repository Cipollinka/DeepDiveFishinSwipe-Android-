...
export default function AppManager() {
  ...
  async function checkDeep() {
    ...
    //   console.log('checkDeep', data);
    //   if (data.targetUrl) {
    //     let parsed = data.targetUrl.split('approved?')[1];
    //     if (parsed[parsed.length - 1] === '/') {
    //       deepParams.current = parsed.slice(0, -1);
    //     }
    //     return;
    //   }
    //   if (data.targetUri) {
    //     let parsed = data.targetUri.split('approved?')[1];
    //     if (parsed[parsed.length - 1] === '/') {
    //       deepParams.current = parsed.slice(0, -1);
    //     }
    //     return;
    //   }
    //   if (data) {
    //     let parsed = data.split('approved?')[1];
    //     if (parsed[parsed.length - 1] === '/') {
    //       deepParams.current = parsed.slice(0, -1);
    //     }
    //   }
